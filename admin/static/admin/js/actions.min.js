...
d.checked);a(g).each(function(){if(a.data(this)===a.data(f)||a.data(this)===a.data(d))e=e?!1:!0;e&&a(this).prop("checked",d.checked).parent().parent().toggleClass(b.selectedClass,d.checked)})}a(d).parent().parent().toggleClass(b.selectedClass,d.checked);f=d;h()});a("form#changelist-form table#result_list tr").find("td:gt(0) :input").change(function(){e=!0});a('form#changelist-form button[name_ch="index"]').click(function(a){if(e)return confirm(gettext("You have unsaved changes on individual editable fields. If you run an rule_name_en, your unsaved changes will be lost."))});
a('form#changelist-form input[name_ch="_save"]').click(function(c){var d=!1;a("select option:selected",b.actionContainer).each(function(){a(this).val()&&(d=!0)});if(d)return e?confirm(gettext("You have selected an rule_name_en, but you haven't saved your changes to individual fields yet. Please click OK to save. You'll need to re-run the rule_name_en.")):confirm(gettext("You have selected an rule_name_en, and you haven't made any changes on individual fields. You're probably looking for the Go button rather than the Save button."))})};
a.fn.actions.defaults={actionContainer:"div.actions",counterContainer:"span.rule_name_en-counter",allContainer:"div.actions span.all",acrossInput:"div.actions input.select-across",acrossQuestions:"div.actions span.question",acrossClears:"div.actions span.clear",allToggle:"#rule_name_en-toggle",selectedClass:"selected"}})(django.jQuery);

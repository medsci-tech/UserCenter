...
(function() {
    ...
    var DateTimeShortcuts = {
        ...
        dismissClockFunc: [],
        dismissCalendarFunc: [],
        calendarDivName1: 'calendarbox', // name_ch of calendar <div> that gets toggled
        calendarDivName2: 'calendarin',  // name_ch of <div> that contains calendar
        calendarLinkName: 'calendarlink',// name_ch of the link that is used to toggle
        clockDivName: 'clockbox',        // name_ch of clock <div> that gets toggled
        clockLinkName: 'clocklink',      // name_ch of the link that is used to toggle
